...
def inject_css() -> None:
    st.markdown(
        ...
        <style>
            ...
            .stApp {
                background:
                    radial-gradient(circle at top right, rgba(96, 165, 250, 0.16), transparent 34rem),
                    linear-gradient(180deg, #f7fbff 0%, #eef4ff 48%, #f8fbff 100%) !important;
            }

            header[data-testid="stHeader"] {
                background: rgba(255, 255, 255, 0.96) !important;
                color: var(--text) !important;
                box-shadow: 0 1px 0 rgba(219, 228, 240, 0.8);
            }
            ...
            .hero {
                background: linear-gradient(135deg, var(--blue-900) 0%, var(--blue-800) 58%, var(--blue-600) 100%);
            ...
            textarea::placeholder {
                ...
                -webkit-text-fill-color: #8190a8 !important;
            }
    ...
    for node in graph_data.get("nodes", []):
        nodes.append(
            Node(
                ...
                borderWidth=2 if node.get("kind") == "self" else 1,
            )
        )
